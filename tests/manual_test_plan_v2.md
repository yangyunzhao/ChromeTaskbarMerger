...
| 7 | Chrome profile 名称持久化评估、2.0.0 发布 | 15/15 及 5/5 只读探测通过 | 通过 | `PASS / APPROVED` |
...
当前状态：`PASS / APPROVED FOR 2.0.0 RELEASE`（2026-07-17）。profile 持久化、实际注销/重新
登录启动和最终便携候选均通过。最大化按钮图标专项已移至 V3，不阻塞本 Phase。
